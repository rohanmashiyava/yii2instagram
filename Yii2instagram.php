 ...
 * Class Documentation: https://github.com/rohanmashiyava/yii2instagram
 *
 * @author Rohan Mashiyava
 * @since 16.1.2016
 * @copyright Rohan Mashiyava - Theta TechnoLabs 2016
 * @version 0.1
...
class Yii2instagram extends Component
{
 ...
 $this->setConfig();
    ...
    public function  setConfig() {
        ...
        $this->setApiSecret($this->apiSecret);
        $this->setApiCallback(Yii::$app->urlManager->createAbsoluteUrl($this->apiCallback));
     ...
     * @return mixed
     *
     * @throws \rohanmashiyava\yii2instagram\insta-src\InstagramException
     */
